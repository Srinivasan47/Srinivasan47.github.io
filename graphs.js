...
var MathGraph = Backbone.Model.extend({
    ...
    addShape: function (config, is_answer) {
        ...
        case 'point':
            ...
            console.log("config poistions - " + config);
        ...
        if (!this.grid_title) {
			if(isLowerGrade)
			{
				this.grid_title = new fabric.Text('', {
					fontFamily: namespace.GRAPHTEXTLOWERGRADEFONTFAMILY,
					fontSize: namespace.GRAPHTEXTLOWERGRADEFONTSIZE,
    ...
    renderAxes: function () {
        ...
        case 'min-max-values':
            ...
            if (data.xAxis.from != data.xAxis.to) {
                /*var wNumberxFrom = data.xAxis.from.roundDecimals(1);
                if (wNumberxFrom % 1 == 0) {
                    // alert('Whole Number');
                    data.xAxis.from = wNumberxFrom;
                }
                var wNumberxTo = data.xAxis.to.roundDecimals(1);
                if (wNumberxTo % 1 == 0) {
                    // alert('Whole Number');
                    data.xAxis.to = wNumberxTo;
                }*/
            ...
            if (data.yAxis.from != data.yAxis.to) {
                var yFrom = data.yAxis.from;
                var yTo = data.yAxis.to;
                /*var wNumberyFrom = data.yAxis.from.roundDecimals(1);
                if (wNumberyFrom % 1 == 0) {
                    // alert('Whole Number');
                    yFrom = wNumberyFrom;
                }
                var wNumberyTo = data.yAxis.to.roundDecimals(1);
                if (wNumberyTo % 1 == 0) {
                    // alert('Whole Number');
                    yTo = wNumberyTo;
                }*/
