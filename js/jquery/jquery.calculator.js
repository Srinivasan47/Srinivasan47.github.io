...
function Calculator() {
	...
	this._keyDefs = {
		...
		'PI': ['π', this.unary, this._pi, 'pi', 'PI', 'p'],
		...
		'XY': ['xʸ', this.binary, this._power, 'fn power', 'POWER', '^'],
	...
	this.regional[''] = { // Default regional settings
		...
		backspaceText: 'Backspace', // Display text for backspace link
		...
		clearText: 'C', // Display text for clear link
...
$.extend(Calculator.prototype, {
	...
	standardLayout: ['@X', '_7_8_9_/CA', '_4_5_6_*CE', '_1_2_3_-BS', '_0_._+_='],
	/* The extended calculator layout with common scientific operations. */
	scientificLayout: ['@X', 'SRSQXYPICA', '_7_8_9_/CE', '_4_5_6_*BS', '_1_2_3_-_=', '_0+-_._+'],
	...
	_generateHTML: function(inst) {
        ...
        if(scientific) {
          ...
          $('.calculator-row:last').css({'margin-top': '-48px', 'float': 'left'});
        }
			}).
    ...
    //removeTools('basic calculator');
    //removeTools('advanced calculator');
    removeTools('calculator');
    removeTools('scientific');
    removeActiveTool();
    //delete canvas_controller.get('currentObject').active_tool;
	}
});
